...
describe Bank do
  ...
  describe "#deposit" do
    it "deposits an amount into an particular account" do
  ...
  describe "#withdraw" do
    it "withdraws an amount from a particualr account" do
      bank.create_account "Bazza", 200
      bank.withdraw "Bazza", 50
      expect(bank.accounts["Bazza"]).to eq 150
    end
  ...
  describe "#balance" do
    it "return the balance for a particular account" do
